...
-- 导出  表 infinity.class 结构
CREATE TABLE IF NOT EXISTS `class` (
  `class_id` bigint(20) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- 正在导出表  infinity.class 的数据：~0 rows (大约)
DELETE FROM `class`;
/*!40000 ALTER TABLE `class` DISABLE KEYS */;
/*!40000 ALTER TABLE `class` ENABLE KEYS */;


-- 导出  表 infinity.domain 结构
...
-- 正在导出表  infinity.domain 的数据：~0 rows (大约)
DELETE FROM `domain`;
/*!40000 ALTER TABLE `domain` DISABLE KEYS */;
/*!40000 ALTER TABLE `domain` ENABLE KEYS */;


-- 导出  表 infinity.domain_fields 结构
...
-- 正在导出表  infinity.methods 的数据：0 rows
DELETE FROM `methods`;
/*!40000 ALTER TABLE `methods` DISABLE KEYS */;
/*!40000 ALTER TABLE `methods` ENABLE KEYS */;


-- 导出  表 infinity.method_signature 结构
...
-- 正在导出表  infinity.method_signature 的数据：0 rows
...
-- 正在导出表  infinity.token 的数据：0 rows
DELETE FROM `token`;
/*!40000 ALTER TABLE `token` DISABLE KEYS */;
/*!40000 ALTER TABLE `token` ENABLE KEYS */;


-- 导出  表 infinity.unittest 结构
...
-- 正在导出表  infinity.vars 的数据：0 rows
DELETE FROM `vars`;
