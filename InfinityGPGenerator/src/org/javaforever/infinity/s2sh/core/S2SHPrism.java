...
import org.javaforever.infinity.s2sh.verb.Add;
import org.javaforever.infinity.s2sh.verb.CountAllPage;
import org.javaforever.infinity.s2sh.verb.Delete;
import org.javaforever.infinity.s2sh.verb.DeleteAll;
import org.javaforever.infinity.s2sh.verb.FindById;
import org.javaforever.infinity.s2sh.verb.FindByName;
import org.javaforever.infinity.s2sh.verb.ListActive;
import org.javaforever.infinity.s2sh.verb.ListAll;
import org.javaforever.infinity.s2sh.verb.ListAllByPage;
import org.javaforever.infinity.s2sh.verb.SearchByName;
import org.javaforever.infinity.s2sh.verb.SoftDelete;
import org.javaforever.infinity.s2sh.verb.SoftDeleteAll;
import org.javaforever.infinity.s2sh.verb.Update;
...
//			this.setDbDefinitionGenerator(dbg);	
	...
	public void generateS2SHCPrismFromDomain() throws Exception{
		if (this.domain != null){
			...
			Verb listAll = new org.javaforever.infinity.s2shc.verb.ListAll(this.domain);
			Verb update = new org.javaforever.infinity.s2shc.verb.Update(this.domain);
			Verb delete = new org.javaforever.infinity.s2shc.verb.Delete(this.domain);
			Verb add = new org.javaforever.infinity.s2shc.verb.Add(this.domain);
			Verb softdelete = new org.javaforever.infinity.s2shc.verb.SoftDelete(this.domain);
			Verb findbyid = new org.javaforever.infinity.s2shc.verb.FindById(this.domain);
			Verb findbyname = new org.javaforever.infinity.s2shc.verb.FindByName(this.domain);
			Verb searchbyname = new org.javaforever.infinity.s2shc.verb.SearchByName(this.domain);
			Verb listactive = new org.javaforever.infinity.s2shc.verb.ListActive(this.domain);
			Verb listAllByPage = new org.javaforever.infinity.s2shc.verb.ListAllByPage(this.domain);
			Verb deleteAll = new org.javaforever.infinity.s2shc.verb.DeleteAll(this.domain);
			Verb softDeleteAll = new org.javaforever.infinity.s2shc.verb.SoftDeleteAll(this.domain);
			
			org.javaforever.infinity.s2shc.verb.CountAllPage countAllPage = new org.javaforever.infinity.s2shc.verb.CountAllPage(this.domain);
